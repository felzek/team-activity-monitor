...
function runGuestPreviewTurn() {
  return {
    answer:
      "Sign in to connect your Jira and GitHub accounts and ask questions about your team's real activity.",
    toolsUsed: [] as string[],
    sources: [],
    partialFailures: [],
  ...
  app.post(
    ...
    async (request, response) => {
      ...
      if (isGuest) {
        ...
        try {
          const previewResult = runGuestPreviewTurn();
